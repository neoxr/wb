    ...
    constructor() {
        ...
        this.reload = (file, delay = 1000) => {
            if (path_1.default.resolve(file) === __filename) {
                console.log(chalk.redBright.bold('[ SKIP ]'), chalk.blueBright((0, moment_timezone_1.default)(Date.now()).format('DD/MM/YY HH:mm:ss')), chalk.green.bold('File cannot reload itself: ' + path_1.default.basename(file)));
                return;
            }
            ...
            const debouncedReload = this.debounce(() => {
                console.log(chalk.redBright.bold('[ UPDATE ]'), chalk.blueBright((0, moment_timezone_1.default)(Date.now()).format('DD/MM/YYYY HH:mm:ss')), chalk.green.bold('~ ' + path_1.default.basename(file)));
