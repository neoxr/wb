...
class Function {
    constructor() {
        ...
        this.color = (text, color = 'green') => {
            return chalk_1.default.keyword(color).bold(text);
        };
        this.mtype = (data) => {
        ...
        this.reload = (file, delay = 1000) => {
            if (path_1.default.resolve(file) === __filename) {
                console.log(chalk_1.redBright.bold('[ SKIP ]'), (0, chalk_1.blueBright)((0, moment_timezone_1.default)(Date.now()).format('DD/MM/YY HH:mm:ss')), chalk_1.green.bold('File cannot reload itself: ' + path_1.default.basename(file)));
                return;
            }
            ...
            const debouncedReload = this.debounce(() => {
                console.log(chalk_1.redBright.bold('[ UPDATE ]'), (0, chalk_1.blueBright)((0, moment_timezone_1.default)(Date.now()).format('DD/MM/YYYY HH:mm:ss')), chalk_1.green.bold('~ ' + path_1.default.basename(file)));
