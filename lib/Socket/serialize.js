    ...
    bind(parent, m, bypassDisappearing = false) {
        try {
            ...
            const text = (m.mtype == 'interactiveResponseMessage' ? JSON.parse(m.msg.nativeFlowResponseMessage.paramsJson).id : '')
                ...
                || (m.mtype == 'stickerMessage' && global.db && global.db.sticker ? (typeof global.db.sticker[m.msg.fileSha256.toString().replace(/,/g, '')] != 'undefined') ? global.db.sticker[m.msg.fileSha256.toString().replace(/,/g, '')].text : '' : '')
