...
exports.Version = exports.NeoxrApi = exports.Utils = exports.Spam = exports.Scraper = exports.JID = exports.Instance = exports.Converter = exports.Cooldown = exports.Config = exports.Database = exports.Client = exports.Chiper = void 0;
...
const memory_store_js_1 = require("./Utils/memory-store.js");
...
const cleanupExpiredMessages = () => {
    try {
        const now = Date.now();
        memory_store_js_1.messageId.forEach((value, key) => {
            const elapsed = now - value.at;
            if (elapsed > 900000) {
                memory_store_js_1.messageId.delete(key);
                // console.log(`Message with ID ${key} removed after 15 minutes`)
            }
        });
    }
    catch { }
