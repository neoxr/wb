...
const chiper_js_1 = __importDefault(require("./Core/Method/chiper.js"));
...
const instances_js_1 = __importDefault(require("./Core/Method/instances.js"));
exports.Instance = instances_js_1.default;
...
const Version = (node_fs_1.default.existsSync('./package.json') ? JSON.parse(node_fs_1.default.readFileSync('./package.json', 'utf-8')) : {})?.dependencies?.['@neoxr/wb'] || '-';
